...
data = gpd.read_file("./geojson-output/{}.geojson".format(file_name))
...
print ("GeoJSON file: CRS {}".format(data.crs))
print ("GeoJSON file: Total Geometry Objects: {}".format(len(data['geometry'])))
print ("GeoJSON file: Dataset Properties: {}, List: {}".format(len(list(data)),list(data)))
print ("End: Loading GeoJSON file for processing...")

## fast avro
print ("===========GeoPackage to Avro ==============")
fast_avro_address_schema = load_schema("{}.avsc".format(avro_schema_file_name))

tic = time.perf_counter()
print ("\nCreating Apache Avro file (fastavro)....")
addresses_fast_avro = []
...
print(f"Timing: Created Apache Avro (fastavro) in {toc - tic:0.4f} seconds")
...
print("File size is {} Kb".format(round(file_size/1024),2))
print(f"Timing: Created Protocol Buffer in {toc - tic:0.4f} seconds")
...
print ("\n\nStart: Deserialize PBF to GeoJSON ....")
tic = time.perf_counter()
...
print("File size is {} Kb".format(round(file_size/1024),2))
print(f"Timing: Deserialized PBF -> GeoJSON in {toc - tic:0.4f} seconds")




print ("\n\nStart: Deserialize FastAvro to GeoJSON ....")
...
print("File size is {} Kb".format(round(file_size/1024),2))
print(f"Timing: Deserialized Avro (fastavro) -> GeoJSON in {toc - tic:0.4f} seconds")
